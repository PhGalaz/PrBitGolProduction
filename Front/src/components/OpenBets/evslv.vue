<template>
  ...
  <v-row
    id="capa6"
    class="ma-0 pa-0"
    style="border-radius:45px;max-width:290px;min-width:290px"
  >
    <v-row
      class="ma-1 pa-0"
    ...
    >
        ...
        <v-row
          ...
          style="border:0px solid #78909C;border-radius:45px;max-width:220px"
        >

          <v-spacer></v-spacer>

            <v-row
              class="ma-0 mr-4 pa-0 font-weight-bold"
              style="color:#CFD8DC;font-size:14px;line-height:12px;max-width:220px"
              align="center"
            >
              <v-spacer></v-spacer>
      ...
      >
        ...
        >
            ...
            <v-row
              class="ma-0 mr-4 pa-0 font-weight-bold text-right"
              style="color:#CFD8DC;font-size:14px;line-height:12px;max-width:220px"
              align="center"
            >
              <v-spacer></v-spacer>
    ...
    >
        ...
        >min</p>
            ...
            <v-row
              id="capa3"
              class="ma-0 pa-0"
              style="border:0px solid rgb(39,205,122);max-width:130px;min-width:130px;border-radius:45px"
            >
              ...
              <v-row
                ...
                class="ma-0 pa-0"
                style="border:0px solid #78909C;border-radius:45px;max-width:130px"
              >
                <v-row
                  id="capa4"
                  class="ma-0 pa-0"
                  style="border-radius:45px;max-width:130px"
                  align="center"
                >
                  ...
                  <p
                    class="ma-0 ml-2 pa-0 font-weight-bold"
                    style="color:#CFD8DC;font-size:14px"
                  >
                    Tie
                  </p>
