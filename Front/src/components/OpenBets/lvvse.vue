<template>
  ...
  >
    <v-row
      id="capa3"
      class="ma-0 pa-0"
      style="border:0px solid rgb(39,205,122);border-radius:45px 0px 0px 45px;max-width:270px"
    >
      <v-avatar
        class="ma-0 pa-0"
        size="50"
      ...
      >min</p>
        ...
        >TAKEN</p>
              ...
              <v-row
                id="capa6"
                class="ma-0 pa-0"
                style="border-radius:45px;max-width:130px;min-width:130px"
              >
              ...
              <v-row
                id="capa5"
                class="ma-0 pa-0"
                style="border:2pz solid red;border-radius:45px;width:40px"
                align="center"
                justify="center"
              >
                <v-icon
                ...
                >
                  ...
                  <v-row
                    class="ma-1 pa-0"
                    style="background-color:#455A64;border-radius:45px;width:13px"
                    justify="center"
                  >
                    <v-avatar
                      class="ma-0 pa-0"
