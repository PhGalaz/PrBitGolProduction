<template>
  ...
  >
    ...
    <v-row
      id="capa3"
      class="ma-0 pa-0"
      style="border:0px solid rgb(39,205,122);border-radius:45px;max-width:130px;min-width:130px"
    >
      <v-avatar
        class="ma-0 pa-0"
        size="50"
      ...
      <v-row
        ...
        class="ma-0 pa-0"
        style="border:0px solid #78909C;border-radius:45px"
      >
        <v-row
          id="capa4"
          class="ma-0 pa-0"
        ...
        >
          ...
          <v-row
            class="ma-0pa-0 font-weight-bold text-right"
            style="color:#CFD8DC;font-size:14px;line-height:16px"
            align="center"
          >
            Tie
          </v-row>
  ...
  >
    ...
    >
      ...
      <v-spacer></v-spacer>
        ...
        >{{ factor }}</p>
        <p
          class="ma-0 mt-1 mr-1 pa-0 font-weight-bold"
          style="color:#CFD8DC;font-size:13px"
        >
          {{ bet.fixture[0].homeTeam[0].team_name}}
        </p>

        <v-img
          class="ma-0 mt-1 mr-3 pa-0"
          max-height="15"
          max-width="15"
