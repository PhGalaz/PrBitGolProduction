  ...
  >
    ...
    >
      <v-img
        ...
        style="-webkit-filter:grayscale(1);filter:grayscale(1);filter:gray;z-index:4"
      ></v-img>

      <v-row
        class="ma-0 mt-1 ml-3 pa-0 font-weight-bold text-left"
        style="color:#CFD8DC;font-size:14px;max-width:140px;z-index:4;line-height:20px"
        align="center"
      >
