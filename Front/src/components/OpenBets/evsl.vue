    ...
    >
      ...
      >
        ...
        <v-row
          id="capa5"
          class="ma-0 pa-0"
          style="border-radius:45px;max-width:220px;min-width:220px"
          align="center"
        >
          ...
          <v-row
            ...
            style="color:#CFD8DC;font-size:17px;max-width:200px;z-index:4;line-height:20px"
            align="center"
          >
            <v-spacer></v-spacer>
...
>
  ...
  >
    <v-img
      class="ma-0 mt-1 ml-3 pa-0"
      max-height="15"
      max-width="15"
      style="-webkit-filter:grayscale(1);filter:grayscale(1);filter:gray"
      :src="bet.fixture[0].awayTeam[0].logo"
    ></v-img>
    <v-row
      class="ma-0 mt-1 ml-1 pa-0 font-weight-bold text-left"
